...
class EditCancelReservation extends StatefulWidget {
  const EditCancelReservation(
      {Key? key, required this.EditCancelReservationEvent})
      : super(key: key);

  final Function(String) EditCancelReservationEvent;

  @override
  _EditCancelReservationState createState() => _EditCancelReservationState();
}

class _EditCancelReservationState extends State<EditCancelReservation> {
                      ...
                      children: [
                        Container(
                          ...
                          padding: const EdgeInsets.only(
                              left: 30, right: 30, bottom: 0, top: 28),
                          child: Column(
